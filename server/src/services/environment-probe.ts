import type { Environment, EnvironmentProbeResult } from "@stapleai/shared";
import type { Db } from "@stapleai/db";
import { ensureSshWorkspaceReady } from "@stapleai/adapter-utils/ssh";
import {
...
export async function probeEnvironment(
  ...
  if (parsed.driver === "local") {
    return {
      ok: true,
      driver: "local",
      summary: "Local environment is available on this Staple host.",
      details: {
