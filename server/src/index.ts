...
export async function startServer(): Promise<StartedServer> {
  ...
  const configuredApiUrl = process.env.STAPLE_API_URL?.trim() || runtimeApiUrl;
  process.env.STAPLE_LISTEN_HOST = runtimeListenHost;
  process.env.STAPLE_LISTEN_PORT = String(listenPort);
  process.env.STAPLE_RUNTIME_API_URL = runtimeApiUrl;
  process.env.STAPLE_RUNTIME_API_CANDIDATES_JSON = JSON.stringify(runtimeApiCandidates);
  process.env.STAPLE_API_URL = configuredApiUrl;
