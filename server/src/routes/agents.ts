...
import { agents as agentsTable, companies, heartbeatRuns, issues as issuesTable } from "@stapleai/db";
...
import { trackAgentCreated } from "@stapleai/shared/telemetry";
...
export function agentRoutes(
  ...
  async function resolveDesiredSkillAssignment(
    ...
    return {
      adapterConfig: writeStapleSkillSyncPreference(adapterConfig, desiredSkills),
      desiredSkills,
      runtimeSkillEntries,
    };
  }
  ...
  router.get("/agents/:id/skills", async (req, res) => {
    ...
    if (!adapter?.listSkills) {
      const preference = readStapleSkillSyncPreference(
