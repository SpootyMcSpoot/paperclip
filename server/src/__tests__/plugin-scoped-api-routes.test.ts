...
import { pluginManifestV1Schema, type StaplePluginManifestV1 } from "@stapleai/shared";
...
function manifest(apiRoutes: NonNullable<StaplePluginManifestV1["apiRoutes"]>): StaplePluginManifestV1 {
  return {
    id: "staple.scoped-api-test",
    apiVersion: 1,
    version: "1.0.0",
