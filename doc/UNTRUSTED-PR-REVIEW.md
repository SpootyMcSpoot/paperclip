...
This is intentionally separate from the normal Staple dev image.
...
```sh
review-checkout-pr stapleai/staple 432
cd /work/checkouts/stapleai-staple/pr-432
```
...
## Preview the Staple app from the PR
...
- Staple's embedded PostgreSQL and local storage stay inside the container home volume via `STAPLE_HOME=/home/reviewer/.staple-review`.
