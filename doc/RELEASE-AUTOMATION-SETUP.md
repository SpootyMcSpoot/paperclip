...
This document covers the GitHub and npm setup required for the current Staple release model:
...
Do this for every public package that Staple publishes.
...
3. add a trusted publisher for the GitHub repository `stapleai/staple`
...
2. revoke any personal automation token that used to publish Staple
