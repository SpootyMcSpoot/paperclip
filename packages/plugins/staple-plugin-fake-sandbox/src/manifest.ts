...
const PLUGIN_ID = "staple.fake-sandbox-provider";
...
const manifest: StaplePluginManifestV1 = {
  ...
  description:
    "First-party deterministic sandbox provider plugin for exercising Staple provider-plugin integration without external infrastructure.",
  author: "Staple",
