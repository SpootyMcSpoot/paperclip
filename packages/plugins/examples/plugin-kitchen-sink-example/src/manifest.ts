...
const manifest: StaplePluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Staple plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "Staple",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Staple domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
