...
import type { StaplePlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@stapleai/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: StaplePluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@stapleai/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
