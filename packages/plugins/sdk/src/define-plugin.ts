/**
 * `definePlugin` — the top-level helper for authoring a Staple plugin.
 *
...
// ---------------------------------------------------------------------------
// StaplePlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 * @returns A sealed `StaplePlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@stapleai/plugin-sdk";
