...
function requireCapability(manifest: StaplePluginManifestV1, allowed: Set<PluginCapability>, capability: PluginCapability) {
 ...
 * can validate plugin behavior without spinning up the Staple server runtime.
 */
