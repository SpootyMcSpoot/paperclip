...
describe("issue references", () => {
  ...
  it("parses relative and absolute issue hrefs", () => {
    ...
    expect(parseIssueReferenceHref("https://staple.ing/PAP/issues/pap-789#comment-1")).toEqual({
      identifier: "PAP-789",
    });
    expect(parseIssueReferenceHref("https://staple.ing/projects/PAP-789")).toBeNull();
  });
