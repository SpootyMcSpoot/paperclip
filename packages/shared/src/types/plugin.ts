...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within StaplePluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the Staple host.
 *
...
export interface StaplePluginManifestV1 {
   ...
   */
  minimumStapleVersion?: PluginMinimumHostVersion;
