...
```
gh api repos/stapleai/staple/security-advisories/{{ghsaId}}
...
```
gh api --method POST \
  repos/stapleai/staple/security-advisories/{{ghsaId}}/forks
...
```
gh api --method POST \
  repos/stapleai/staple/security-advisories/{{ghsaId}}/cve
...
```
gh api repos/stapleai/staple/security-advisories/{{ghsaId}} --jq '.credits'
...
```
gh api --method PATCH \
  repos/stapleai/staple/security-advisories/{{ghsaId}} \
  --input - << 'EOF'
{
  "credits": [
    {
...
### Advisory
https://github.com/stapleai/staple/security/advisories/{{ghsaId}}
...
gh release view v{{patchedVersion}} --repo stapleai/staple
...
* The published advisory URL: `https://github.com/stapleai/staple/security/advisories/{{ghsaId}}`
* The release URL
