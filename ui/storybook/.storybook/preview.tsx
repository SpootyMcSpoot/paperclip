...
function installStorybookApiFixtures() {
  ...
  const currentWindow = window as typeof window & {
    __stapleStorybookFetchInstalled?: boolean;
  };
  if (currentWindow.__stapleStorybookFetchInstalled) return;

  const originalFetch = window.fetch.bind(window);
  currentWindow.__stapleStorybookFetchInstalled = true;
