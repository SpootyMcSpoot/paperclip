...
import type { HeartbeatRun, Issue } from "@stapleai/shared";
...
function CompanyPatternIconMatrix() {
  const companies = [
    { name: "Staple Storybook", color: "#0f766e" },
...
function AsciiArtAnimationDemo({ loading = false }: { loading?: boolean }) {
  return (
    <StoryShell>
      <Section eyebrow="AsciiArtAnimation" title={loading ? "Loading art surface" : "Animated ASCII staple field"}>
