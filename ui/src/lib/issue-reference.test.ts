...
describe("issue-reference", () => {
  ...
  it("does not treat GitHub issue URLs as internal Staple issue links", () => {
    expect(parseIssuePathIdFromPath("https://github.com/stapleai/staple/issues/1778")).toBeNull();
    expect(parseIssueReferenceFromHref("https://github.com/stapleai/staple/issues/1778")).toBeNull();
  });
