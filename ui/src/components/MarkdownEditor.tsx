...
import { buildProjectMentionHref, parseProjectMentionHref } from "@stapleai/shared";
...
export const MarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditor({
    ...
    for (const node of links) {
      ...
      if (!parsed) {
        if (link.dataset.projectMention === "true") {
          ...
          link.classList.remove("staple-project-mention-chip");
      ...
      link.classList.add("staple-project-mention-chip");
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative staple-mdxeditor-scope",
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("staple-mdxeditor", !bordered && "staple-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "staple-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
        plugins={plugins}
      />
