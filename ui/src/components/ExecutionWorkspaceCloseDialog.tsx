...
import type { ExecutionWorkspace } from "@stapleai/shared";
      ...
      <DialogContent className="max-h-[85vh] overflow-y-auto sm:max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription className="break-words">
            ...
            artifacts. Staple keeps the workspace record and issue history, but removes it from active workspace views.
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter>
          ...
          >
            {closeWorkspace.isPending ? <Loader2 className="mr-2 h-4 w-4 animate-spin" aria-hidden="true" /> : null}
            {actionLabel}
          </Button>
        </DialogFooter>
      </DialogContent>
