...
function AgentSkillsTab({
  ...
  const unsupportedSkillMessage = useMemo(() => {
    ...
    if (agent.adapterType === "openclaw_gateway") {
      return "Staple cannot manage OpenClaw skills here. Visit your OpenClaw instance to manage this agent's skills.";
    }
    return "Staple cannot manage skills for this adapter yet. Manage them in the adapter directly.";
