...
import type { AuthSession, CurrentUserProfile, UpdateCurrentUserProfile } from "@stapleai/shared";
...
export function ProfileSettings() {
  ...
  const uploadHint = selectedCompany
    ? `Stored in Staple file storage for ${selectedCompany.name}.`
    : "Select a company to upload an avatar into Staple storage.";
