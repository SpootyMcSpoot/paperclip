...
- [ ] The first paragraph points at the Staple skill as the source of truth for the heartbeat procedure
...
- [ ] For execution-heavy roles (coders, operators, designers, security, QA), `AGENTS.md` includes the Staple execution contract verbatim:
...
- [ ] Adapter config matches this Staple instance (cwd, model, credentials) per `/llms/agent-configuration/<adapter>.txt`
