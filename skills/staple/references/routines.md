...
- Fire externally: `POST /api/routine-triggers/public/{publicId}/fire`
  ...
  - HMAC: `X-Staple-Signature` + `X-Staple-Timestamp` headers
...
Use the generic API endpoint tables in `skills/staple/references/api-reference.md` when you need a full cross-domain reference. Use this file when you need routine-specific behaviour, payload shape, or policy details.
